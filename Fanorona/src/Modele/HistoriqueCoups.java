...
public class HistoriqueCoups {
	...
	*/
	ArrayList<Coup> coups_annules;
        ...
        /**
        * Nom du dossier oÃ¹ sauvegarder les parties
        */
	...
	/**
	 * Supprimer le dernier coup annulï¿½ï¿½ de la liste quand utilisateur refaire le coup
	 * @return liste de coups annulï¿½ï¿½ sans le dernier coup annulï¿½ï¿½
	 */
    ...
    public String exporter() {
    	...
    	afficheCoups();
    	afficheCoupsAnnules();
    	System.out.println("Fin exporter");
    	return nom_fichier;
    }
    ...
    /**
     * Transforme le chaine de caracteres ï¿½ï¿½ form d'un coup
     * @param ligne_coup : la chaine de caracteres ï¿½ï¿½ analyser
     * @return un coup
     */
	private Coup construireCoup(String[] ligne_coup) {
	...
	public void afficheCoups() {
		System.out.println("Affiche coups : "+stringCoups(coups));
	}
	...
	public void afficheCoupsAnnules() {
		System.out.println("Affiche coups annul¨¦s : "+stringCoups(coups_annules));
	}
	
	/**
	 * Copie la liste des coups joues pendant le jeu
	 * @return une liste de coups copiï¿½ï¿½
	 */
